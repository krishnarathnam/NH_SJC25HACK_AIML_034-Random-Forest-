...
const MergeSortVisualizer = ({ isOpen, onClose }) => {
  ...
  const handleNext = () => {
    ...
    if (currentStep >= steps.length) {
      setDescription('✅ Sorting Complete! The array is fully sorted.');
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm animate-fadeIn">
      <div className="bg-white rounded-2xl shadow-2xl w-[90%] max-w-4xl max-h-[90vh] overflow-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-purple-50">
          <div>
            <h2 className="text-2xl font-bold text-gray-800">Merge Sort Visualizer</h2>
            <p className="text-sm text-gray-600 mt-1">Watch how Merge Sort divides and conquers using recursion</p>
          </div>
        ...
        <div className="p-6 bg-gray-50 border-t border-gray-200 rounded-b-2xl">
          <h3 className="font-bold text-gray-800 mb-2">How Merge Sort Works:</h3>
          <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
            <li>Divide the array recursively into two halves</li>
            <li>Sort each half independently</li>
            <li>Merge the sorted halves back together</li>
            <li>Continues until single elements (base case)</li>
            <li>Time Complexity: O(n log n) | Space Complexity: O(n)</li>
          </ul>
        </div>
      </div>
    </div>

    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md">
      <div className="bg-white w-[85%] max-w-3xl max-h-[90vh] overflow-auto" style={{ borderRadius: '4px', boxShadow: '0 0 0 1px rgba(0,0,0,0.05), 0 20px 40px rgba(0,0,0,0.15)' }}>
        ...
        <div className="flex items-center justify-between px-8 py-6 border-b border-gray-100">
          <div>
            <h2 className="text-xl font-semibold text-gray-900 tracking-tight">Insertion Sort</h2>
            <p className="text-sm text-gray-500 mt-0.5">Builds sorted array one element at a time</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-8 py-6 bg-gray-50 border-t border-gray-100">
          ...
          <div className="text-sm text-gray-600 space-y-2">
            <p>• Picks element from unsorted portion and inserts it</p>
            <p>• Shifts larger elements right to make space</p>
            <p>• Time: O(n²) average & worst | Space: O(1)</p>
          </div>
        </div>
      </div>
    </div>
